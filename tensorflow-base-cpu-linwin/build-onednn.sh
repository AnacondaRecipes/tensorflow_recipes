...
# SOURCE: https://github.com/ARM-software/Tool-Solutions/blob/97090bf1bcfa3d928b72e8c5b0a8e5aade5097cd/docker/tensorflow-aarch64/scripts/build-onednn.sh
...
patch -p1 < ${PREFIX}/oneDNN.patch

cmake_options="-DCMAKE_BUILD_TYPE=release \
  -DDNNL_CPU_RUNTIME=OMP \
  -DCMAKE_INSTALL_PREFIX=${BUILD_PREFIX}/$package/release"
